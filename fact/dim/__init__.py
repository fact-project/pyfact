...
class DimServer(object):
    ...
    def _change_services_to_dict(self):
    ...
    def has_service(self, full_service_name):
        list_of_service_names = [service.name for service in self.services]
...
def ask_dns_for_servers(dns_name):
...
servers = ask_dns_for_servers(gl.dns_name)
