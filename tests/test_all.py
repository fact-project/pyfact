...
def test_patch_indices():
    from fact.instrument.pixels import patch_indices
...
def test_coords_relation_to_pos_from_dataframe():
    ...
    from fact.instrument.pixels import get_pixel_dataframe
    from fact.instrument.pixels import get_pixel_coords
    import numpy as np
